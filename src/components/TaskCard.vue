    ...
    <div class="task-card-body">
      <div class="details">
        ...
        <div class="task-details">
          ...
          <p class="left-days">{{ task.remainingDays }} day left</p>
          <div class="hours">
      ...
      <div class="message" v-if="task && task.username">
        <div class="wrapper">
          <input type="checkbox" value="" v-model="sendToDraft" />
          <label class="label" :class="{ checked: sendToDraft }"
            >Replay to {{task.username}} message</label
          >
        </div>
        <div class="wrapper">
          <input type="checkbox" value="" v-model="replyTo" />
          <label class="label" :class="{ checked: replyTo }"
            >Send a draft</label
          >
        </div>
      </div>
